...
public class CommandList {
	 ...
	 * @return Bool erfolreich: Liefert eine 1 zurück, wenn das Element erfolgreich hinzugefügt wurde.
	 */
	...
	/**
	 * Mit der Methode remove kann ein Element an einer bestimmten Position gelöscht werden. 
	 * @author Andreas Sautter
	 * @param pos Position der verketteten Liste
	 * @return Liefert eine 1 zurück, wenn das Element erfolgreich gelöscht wurde. 
	 */
	...
	/**
	 * Mit der Methode get kann auf ein bestimmtes Element in der Liste zugegriffen werden
	 * und liefert den Inhalt des Elements zurück.   
	 * @param pos Position der verketteten Liste
	 * @return Lierfert als Rückgabewert ein Objekt von Typ Command.
	 */
	...
	/**
	 * Mit der Methode moveUp kann ein bestimmtes Element in der Liste  hoch geschoben werden.
	 * @param pos Position der verketteten Liste
	 * @return Liefert eine 1 zurück wenn die Operation erfolgreich war. 
	 */
	...
	/**
	 * Mit der Methode moveDown kann ein bestimmtes Element in der Liste  runter geschoben werden.
	 * @param pos Position der verketteten Liste
	 * @return Liefert eine 1 zurück wenn die Operation erfolgreich war.
	 */
